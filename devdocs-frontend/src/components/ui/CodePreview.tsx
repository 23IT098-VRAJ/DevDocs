...
export function CodePreview({ code, language, className = '' }: CodePreviewProps) {
  ...
  if (!code.trim()) {
    return (
      <div className={`rounded-lg bg-slate-900 border border-slate-700 p-6 ${className}`}>
  ...
  return (
    <div className={`rounded-lg bg-slate-900 border border-slate-700 overflow-hidden ${className}`}>
      {/* Header */}
      ...
      <div className="relative overflow-x-auto">
        <pre className="m-0! p-4! bg-slate-900! text-sm leading-relaxed">
