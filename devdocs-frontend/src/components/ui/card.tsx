...
export const Card = forwardRef<HTMLDivElement, CardProps>(
  (
    ...
    const variantStyles = {
      ...
      elevated: 'shadow-xl shadow-black/40 hover:shadow-2xl hover:shadow-cyan-400/50 border-l-4 border-l-cyan-400/50',
      outlined: 'border-2 border-slate-600 shadow-md hover:border-cyan-400/70 hover:shadow-lg hover:shadow-cyan-400/30',
    };
    ...
    const clickableStyles = clickable
      ? cn(
          'cursor-pointer',
          'hover:shadow-2xl hover:shadow-cyan-400/50 hover:scale-[1.02] hover:border-cyan-400/70',
          'active:scale-[0.98]',
          'border-l-4 border-l-transparent hover:border-l-cyan-400'
        )
      : '';
